"""
    N-body simulation.
"""
# here i interpreted "Reducing function call overhead" to be reducing function calls that did not invovle loops, since that seems to be part 4?
#import time 
