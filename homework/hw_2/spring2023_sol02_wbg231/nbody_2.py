...
## here we just avoided memvership testing by using sets 
...
def advance(dt):
    ...
    '''
    seenit = set()
    boddy_keys=set(BODIES.keys())
    for body1 in boddy_keys:
        for body2 in boddy_keys:
...
#print(" time: %0.10f"% (elapsed_time_c))

## this takes 38.2181377000